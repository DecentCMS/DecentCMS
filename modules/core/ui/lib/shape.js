 ...
 * @constructor
 */
var Shape = function(shell) {
  this.shell = shell;
};
Shape.isShellSingleton = true;
 ...
 */
Shape.prototype.meta = function(shape) {
 ...
 */
Shape.prototype.parseOrder = function(orderString) {
 ...
 */
Shape.prototype.insert = function(shapes, shape, order) {
